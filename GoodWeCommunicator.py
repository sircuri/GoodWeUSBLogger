...
class GoodWeCommunicator(object):
	...
	def setDevice(rawdevice):
		# New device setted. Restart state machine.
	...
	def openDevice(self):
		try:
			...
			print ("Connected to " + self.rawdevice)
			
			return True
		except Exception as e:
			print("Unable to open " + self.rawdevice)
			return False
